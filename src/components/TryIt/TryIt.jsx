  ...
  return (
    <AosProvider fade="fade-up" duration={1000}>
      <section className=" max-w-[1366px] h-auto m-auto py-20 px-4">
        <h1
          className="xl:text-[50px] text-[16px] text-center font-medium xl:font-black md:text-[22px]
         text-purple-700 xl:text-cyan950 font-neue-ltcd"
        >
          TRY IT
        </h1>
        <p
          className="md:leading-9 xl:text-[32px] text-[22px] md:text-[32px] text-center font-medium xl:text-cyan700
         text-cyan950 font-neue-ltcd md:leading-normal"
        >
          Run this code to get
          <br className="xl:hidden" />a random card.
        </p>

        {/* Contenedor de scripts y card */}
        <div
          className="flex justify-center xl:justify-around
         flex-col xl:flex-row mt-5 "
        >
          {/* Contenedor de scripts */}

          <div
            className="xl:w-[717px] h-[auto] xl:relative xl:pt-14 my-10 
          flex justify-center xl:block gap-3 xl:mr-[78px]"
          >
            <div
              className="xl:w-full xl:h-[130px] w-[262px] h-[40px] md:w-[427px]
            ...
            <div
              className="xl:flex sm:hidden md: hidden w-full min-h-[130px] max-h-[172px]
             bg-cyan950 mt-28 rounded-md"
            >
              <HighlighterComponent
                wrapLines={true}
                language="json"
        ...
        <div className="flex xl:justify-end justify-center w-full h-20 mt-[202px] mb-8 xl:mt-14 xl:mb-0">
          <div className="w-[394px] text-center">
            <p className="font-medium xl:text-2xl text-[20px] text-cyan950 font-neue-ltcd md:text-[30px]">
              <span className="text-cyan700 ">EXPLORE</span> DOCUMENTATION{" "}
              <span className="text-cyan700">NOW!</span>
            </p>
